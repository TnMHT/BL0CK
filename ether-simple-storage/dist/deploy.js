...
async function main() {
    ...
    const privateKey = '0x6fcac237545f3716d7bd53f984a811df3ede3491ae75385bafb481c35bc3d9b7';
    ...
    const binrary = fs.readFileSync('./SimpleStorage_sol_SImpleStorage.bin', 'utf8');
    ...
    // GET NUMBER
    const currentFavNumber = await contract.getFunction('retrieve');
